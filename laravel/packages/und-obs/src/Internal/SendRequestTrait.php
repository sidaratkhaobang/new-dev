...
use UndObs\Internal\Resource\V2Constants;
use UndObs\ObsException;
use UndObs\Internal\Signature\V4Signature;
use UndObs\Internal\Signature\DefaultSignature;
use UndObs\Internal\Resource\Constants;
use UndObs\Internal\Resource\V2RequestResource;
