...
use League\Flysystem\FilesystemAdapter as interface2;
use League\Flysystem\FileAttributes;
use Illuminate\Contracts\Filesystem\Filesystem as interface1;

/**
 * Class ObsAdapter
 * @package Obs
 */
class ObsAdapterBackup implements interface1
{
    /**
     * @var ObsClient
     */
    ...
    {
        $path = $this->applyPathPrefix($from);
        $newpath = $this->applyPathPrefix($to);
