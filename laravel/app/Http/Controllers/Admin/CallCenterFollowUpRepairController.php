...
class CallCenterFollowUpRepairController extends Controller
{
    public function index(Request $request)
    {
        $this->authorize(Actions::View . '_' . Resources::CallCenterFollowUpRepair);
        ...
        return view('admin.accident-follow-up-repairs.index-call-center', [
            'list' => $list,
    ...
    public function show(AccidentRepairOrder $call_center_follow_up_repair)
    {
        $this->authorize(Actions::View . '_' . Resources::CallCenterFollowUpRepair);
        $accident = Accident::find($call_center_follow_up_repair->accident_id);
        ...
        $condotion_lt_rental =  RepairTrait::getConditionQuotation($call_center_follow_up_repair);
        ...
        $repair_list = FollowAccidentRepair::where('accident_repair_order_id', $call_center_follow_up_repair->id)->get();
        ...
        $page_title = $page_title = __('lang.view') . __('accident_follow_up_repairs.page_title_call_center');
        return view('admin.accident-follow-up-repairs.form',  [
            'car_license' => $car_license,
            'car_data' => $car_data,
            'd' => $call_center_follow_up_repair,
            'rental' => $rental,
            'need_list' => $need_list,
