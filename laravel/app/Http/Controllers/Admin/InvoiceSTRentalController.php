...
class InvoiceSTRentalController extends Controller
{
    public function index(Request $request)
    {
        $this->authorize(Actions::View . '_' . Resources::ShortTermRentalInvoice);
        ...
        return view('admin.invoice-st-rentals.index', [
            'list' => $list,
