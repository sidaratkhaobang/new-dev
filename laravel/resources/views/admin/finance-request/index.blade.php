                            ...
                            <tr>
                                ...
                                <td>
                                    @include('admin.components.dropdown-action', [
                                                                            'view_route' => route('admin.finance-request.show', ['finance_request' => $d->lot_id,'status' => $d?->status]),
                                                                            'edit_route' => route('admin.finance-request.edit', ['finance_request' => $d->lot_id,'status' => $d?->status]),
