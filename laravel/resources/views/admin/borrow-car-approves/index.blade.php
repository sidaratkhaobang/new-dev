                                ...
                                <tr>
                                    ...
                                    <td class="sticky-col text-center">
                                        @include('admin.components.dropdown-action', [
                                            'view_route' => route('admin.borrow-car-approves.show', [
                                                'borrow_car_approve' => $d,
                                            ]),
                                            'view_permission' => Actions::View . '_' . Resources::BorrowCarApprove,
                                            'manage_permission' =>
                                                Actions::Manage . '_' . Resources::BorrowCarApprove,
                                        ])
