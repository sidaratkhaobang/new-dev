<x-blocks.block-search>
            <form action="" method="GET" id="form-search">
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <x-forms.select-option id="status_transfer" :value="null" :list="[]" :optionals="[
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-ภ">
                            <x-forms.date-input id="month_last_payment_transfer" :value="null" :label="__('ownership_transfers.month_last_payment')" />
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <x-forms.select-option id="leasing_transfer" :value="null" :list="[]"
                            :optionals="[
                                'select_class' => 'js-select2-custom',
                                'ajax' => true,
                                'default_option_label' => null,
                ...
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <x-forms.select-option id="car_id_transfer" :value="null" :list="[]"
                            :optionals="[
                                'select_class' => 'js-select2-custom',
                                'ajax' => true,
                                'default_option_label' => null,
                    ...
                    <div class="col-sm-8">
                        <x-forms.select-option id="car_class_transfer" :value="null" :list="[]"
                            :optionals="[
                                'select_class' => 'js-select2-custom',
                                'ajax' => true,
                                'default_option_label' => null,
                ...
                <div class="row mt-4">
                    <div class="col-sm-12 text-end">
                        ...
                        <button type="button" onclick="checkCarTransfer()" class="btn btn-primary btn-custom-size"><i
