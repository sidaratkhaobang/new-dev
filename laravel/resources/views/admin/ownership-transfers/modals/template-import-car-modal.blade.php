        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="template-import" v-cloak data-detail-uri="" data-title="">
                    @include('admin.ownership-transfers.section-template-imports.car-list')
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-save-form-import-modal"
                    data-status-import="{{ OwnershipTransferStatusEnum::TRANSFERED }}"><i class="icon-check"></i>
                    {{ __('ownership_transfers.save_ownership_transfer') }}</button>
            </div>
        </div>
    </div>
</div>
@include('admin.ownership-transfers.scripts.template-import-script')
@push('scripts')
    <script>
        $(".btn-save-form-import-modal").on("click", function() {
            ...
            import_list.forEach((
                ...
                import_list_arr[import_data.id].leasing_name = import_data.leasing_name;
                import_list_arr[import_data.id].car_class = import_data.car_class;
                import_list_arr[import_data.id].cc = import_data.cc;
                import_list_arr[import_data.id].engine_no = import_data.engine_no;
                import_list_arr[import_data.id].chassis_no = import_data.chassis_no;
                import_list_arr[import_data.id].car_class = import_data.car_class;
                import_list_arr[import_data.id].car_color = import_data.car_color;
                import_list_arr[import_data.id].license_plate = import_data.license_plate;
                import_list_arr[import_data.id].receive_registration_book_date = import_data.receive_registration_book_date;
                import_list_arr[import_data.id].car_ownership_date = import_data.car_ownership_date;
                import_list_arr[import_data.id].return_registration_book_date = import_data.return_registration_book_date;
                ...
                import_list_arr[import_data.id].receipt_fee = import_data.receipt_fee;
            ...
            $.ajax({
                ...
                url: "{{ route('admin.ownership-transfers.store-import-excel') }}",
