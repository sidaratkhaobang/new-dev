...
@section('content')
    ...
    <form id="save-form">
        {{-- @include('admin.ownership-transfers.btn-group') --}}
        ...
        @include('admin.ownership-transfers.section-transferings.transfer-detail')
        @include('admin.ownership-transfers.section-transferings.proceed-detail')
...
@include('admin.components.form-save', [
    'store_uri' => route('admin.ownership-transfers.store-transfering'),
])
...
@push('scripts')
    <script>
        ...
        $("#find_copy_chassis_date").attr('disabled', true);
        $("#transfer_date").attr('disabled', true);
        $("#estimate_transfered_date").attr('disabled', true);
        $("#amount_actual_transfer_date").attr('disabled', true);
        ...
        $(document).ready(function() {
            ...
            var transfer_date = new Date($('#transfer_date').val());
            var receive_registration_book_date = new Date($('#receive_registration_book_date').val());

            // amount_wait_transfer_kit_date
            $('#transfer_date , #receive_registration_book_date').on('change', function() {
                var transfer_date = new Date($('#transfer_date').val());
                var receive_registration_book_date = new Date($('#receive_registration_book_date').val());
                var day_diff = DateDifference(transfer_date, receive_registration_book_date, );
                $('#amount_actual_transfer_date').val(day_diff);
            });

            var amount_actual_transfer_date = DateDifference(
                transfer_date, receive_registration_book_date);
            $('#amount_actual_transfer_date').val(amount_actual_transfer_date);
        ...
        $(".btn-save-form-ownership").on("click", function() {
            let storeUri = "{{ route('admin.ownership-transfers.store-transfering') }}";
