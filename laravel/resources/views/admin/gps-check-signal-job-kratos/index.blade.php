                                ...
                                <div class="dropdown dropleft">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-dropleft-dark">
                                        <a class="dropdown-item"
                                            href="{{ route('admin.gps-check-signal-job-kratos.show', ['gps_check_signal_job_krato' => $d]) }}"><i
                                                class="fa fa-eye me-1"></i>
                                            {{ __('config_approves.view') }}
                                        </a>
                                        <a class="dropdown-item"
                                            href="{{ route('admin.gps-check-signal-job-kratos.edit', ['gps_check_signal_job_krato' => $d]) }}"><i
