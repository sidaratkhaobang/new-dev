...
<div class="mb-4" id="car-accessory" v-cloak data-detail-uri="" data-title="">
    <div class="table-wrap">
                            ...
                            <td class="td-table table-wrap" colspan="6">
                                <table class="table table-striped">
                                    ...
                                    <tbody v-for="(accessory, accessory_index) in item.accessory_list">
                                       ...
                                       <td></td>
                                       {{-- <td></td> --}}
                                       <input type="hidden" v-bind:name="'cars['+ index +'][accessory]['+ accessory_index +'][id]'"
                                       id="accessory_id" v-bind:value="accessory.accessory_id">
                                       <input type="hidden" v-bind:name="'cars['+ index +'][accessory]['+ accessory_index +'][amount_per_car]'"
                                       id="accessory_amount_per_car" v-bind:value="accessory.amount_per_car_accessory">
                                       <input type="hidden" v-bind:name="'cars['+ index +'][accessory]['+ accessory_index +'][amount]'"
                                       id="accessory_amount" v-bind:value="accessory.amount_accessory">
                                       <input type="hidden" v-bind:name="'cars['+ index +'][accessory]['+ accessory_index +'][remark]'"
                                       v-bind:value="accessory.remark">
                                       <input type="hidden" v-bind:name="'cars['+ index +'][accessory]['+ accessory_index +'][type_accessories]'"
        ...
        <div v-for="(item) in pending_delete_car_ids">
            <input type="hidden" v-bind:name="'pending_delete_car_ids[]'"
                v-bind:value="item">
        </div>
    </div>
    @if (!isset($view_only))
...
<br>
@include('admin.long-term-rental-spec-tors.modals.car-accessory-modal')
