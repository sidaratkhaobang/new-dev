    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-start" id="approve-modal-label">ยืนยันอนุมัติ ใบขอสั่งซื้อ</h5>
            </div>
            <div class="modal-body pb-1">
                <p id="approve-modal-body">เมื่อยืนยันใบขอสั่งซื้อแล้ว ระบบจะส่งข้อมูลคำขอนี้เพื่อดำเนินการในส่วนต่อไป</p>
...
@push('scripts')
    <script>
        ...
        $(".btn-submit-approve").on("click", function() {
            var ids = document.getElementById("approve_id").value;
            ids = ids.split(',');
            var data = {
                pr_status: document.getElementById("approve_status").value,
