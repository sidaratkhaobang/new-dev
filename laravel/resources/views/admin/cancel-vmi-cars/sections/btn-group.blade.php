...
<div class="wrapper mb-4">
    <ul class="nav nav-btn-custom" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="first-tab" data-bs-toggle="tab"
                data-bs-target="#first" role="tab" aria-controls="first"
                aria-selected="true">{{ __('vmi_cars.act_detail') }}</a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="third-tab" data-bs-toggle="tab"
                data-bs-target="#third" role="tab" aria-controls="third"
                aria-selected="true" tabindex="-1">{{ __('cmi_cars.cancel_info') }}</a>
        </li>
    </ul>
</div>
