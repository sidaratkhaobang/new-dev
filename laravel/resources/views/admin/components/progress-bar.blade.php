        ...
        <div class="form-progress-bar">
            <div class="form-progress-bar-header">
                ...
                <ul class="list-unstyled form-progress-bar-labels clearfix">
                    <li class="{{ $active[0] ? 'activated' : '' }}"><span>ประเภทงาน</span></a></li>
                    <li class="{{ $active[1] ? 'activated' : '' }}"><span>รายละเอียดการจอง</span></li>
                    <li class="{{ $active[2] ? 'activated' : '' }}"><span>สินค้า</span></li>
                    <li class="{{ $active[3] ? 'activated' : '' }}"><span>รายละเอียดสินค้า</span></li>
                    <li class="{{ $active[4] ? 'activated' : '' }}"><span>โปรโมชั่นและส่วนลด</span></li>
                    <li class="{{ $active[5] ? 'activated' : '' }}"><span>สรุปข้อมูล</span></li>
                </ul>
            </div>
        </div>
    </div>
