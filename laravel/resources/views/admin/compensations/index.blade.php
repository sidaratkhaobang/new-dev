                                    ...
                                    <td class="sticky-col text-center">
                                        @php
                                            ...
                                            if (!in_array($d->status, [CompensationStatusEnum::PENDING_REVIEW, CompensationStatusEnum::COMPLETE])) {
                                                $edit_route = route('admin.compensations.edit', ['compensation' => $d]);
                                                $delete_route = route('admin.compensations.destroy', ['compensation' => $d]);
                                            }
                                        @endphp
                                        <x-tables.dropdown 
                                            :view-route="route('admin.compensations.show', ['compensation' => $d])"
