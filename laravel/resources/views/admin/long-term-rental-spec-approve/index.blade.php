...
@section('page_title', __('long_term_rentals.specs_approve'))
                            ...
                            <tr>
                                ...
                                <td class="sticky-col text-center" style="width: 100px;">
                                    @include('admin.components.dropdown-action', [
                                        'view_route' => route('admin.long-term-rental.specs-approve.show', ['rental' => $d]),
                                        'view_permission' => Actions::View . '_' . Resources::LongTermRentalSpecApprove
                                    ])
                                </td>
                            </tr>
                        @endforeach
