@push('scripts')
    <script>
        let addPurchaseOrderDealerVue = new Vue({
            ...
            data: {
                purchase_requisition_car_list: @if (isset($purchase_requisition_car_list)) @json($purchase_requisition_car_list) @else [] @endif,
            ...
            methods: {
                ...
                loadModalData: function(index){
                    ...
                    this.purchase_requisition_car_list.forEach(function(car, index) {
                        ...
                        $("#"+ car.id + "_price_field").val(parseFloat(dealer_price.car_price));
                ...
                getDataFromModalAdd: function() {
                    ...
                    this.purchase_requisition_car_list.forEach(function(car) {
                        ...
                        total += parseFloat(car_price) * car.amount;
