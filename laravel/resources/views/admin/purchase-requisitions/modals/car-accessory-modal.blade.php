        ...
        <div class="modal-content">
                ...
                <div class="row push mb-3">
                    <div class="col-sm-12">
                        <x-forms.select-option id="car_class_field" :value="null" :list="null"
                                               :label="__('long_term_rentals.car_class')"
                ...
                <div class="row push mb-3">
                    <div class="col-sm-8">
                        <x-forms.select-option id="car_color_field" :value="null" :list="null"
                                               :label="__('long_term_rentals.car_color')"
                                               :optionals="['select_class' => 'js-select2-custom', 'ajax' => true]"/>
                    </div>
                    <div class="col-sm-4">
                        <x-forms.input-new-line id="amount_car_field" :value="null"
                                                :label="__('long_term_rentals.car_amount')"
                                                :optionals="['required' => true, 'oninput' => true, 'type' => 'number']"/>
                    </div>
                </div>
                <div class="row push mb-3">
                    <div class="col-sm-12">
                        <x-forms.text-area-new-line id="remark_car_field" :value="null"
                                                    :label="__('long_term_rentals.remark')"/>
                    </div>
                </div>
                {{-- <div class="row push mb-3">
                    <div class="col-sm-12">
            ...
            <div class="modal-body">
                ...
                <div class="row push">
                    <div class="col-sm-8">
                        <x-forms.select-option id="accessory_field" :value="null" :list="null"
                                               :label="__('long_term_rentals.car_accessory')"
                                               :optionals="['select_class' => 'js-select2-custom', 'ajax' => true]"/>
                    </div>
                    <div class="col-sm-4">
                        <x-forms.input-new-line id="amount_per_car_accessory_field" :value="null"
                                                :label="__('long_term_rentals.amount_per_car')"
                ...
                <div class="row push">
                    <div class="col-sm-4">
                        ...
                        <x-forms.input-new-line id="amount_accessory_field" :value="null"
                                                :label="__('long_term_rentals.total_amount')"
                                                :optionals="['oninput' => true, 'type' => 'number']"/>
                    </div>
                </div>
                <div class="row push mb-3">
                    <div class="col-sm-12">
                        <x-forms.text-area-new-line id="remark_accessory" :value="null"
                                                    :label="__('long_term_rentals.remark')"/>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div id="pr-accessory" v-cloak data-detail-uri="" data-title="">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr class="table-empty">
                                <td class="text-center" colspan="6">"
                                    {{ __('lang.no_list') . __('long_term_rentals.accessories_table') }} "
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-save-car"
                        onclick="saveCarAccessory($(this))">{{ __('lang.save') }}</button>
            </div>
        </div>
    </div>
</div>
