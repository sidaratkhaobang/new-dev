<div class="justify-content-between">
    <form action="" method="GET" id="form-search">
        ...
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.select-option id="branch_id" :value="$branch_id" :list="$branch_list" :label="__('สาขา')" />
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <x-forms.select-option id="status" :value="$status" :list="$statusList" :label="__('สถานะ')" />
            </div>
        </div>
