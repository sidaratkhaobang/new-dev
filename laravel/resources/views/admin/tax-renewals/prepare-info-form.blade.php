...
@push('scripts')
    <script>
        ...
        $(".btn-save-form-tax-renewal").on("click", function() {
            let storeUri = "{{ route('admin.tax-renewals.store') }}";
        ...
        $(document).ready(function() {
            function checkAndToggle() {
                var is_check_inspection = $('input[name="is_check_inspection"]:checked').val();
                var is_check_lpg_ngv = $('input[name="is_check_lpg_ngv"]:checked').val();
                var is_check_blue_sign = $('input[name="is_check_blue_sign"]:checked').val();
                var is_check_yellow_sign = $('input[name="is_check_yellow_sign"]:checked').val();
                var is_check_green_sign = $('input[name="is_check_green_sign"]:checked').val();

                if (is_check_inspection == true ||
                    is_check_lpg_ngv == true ||
                    is_check_blue_sign == true ||
                    is_check_yellow_sign == true ||
                    is_check_green_sign == true) {
                    $('#is_receive_document_label').show();
                } else {
                    $('#is_receive_document_label').hide();
                }
            }
            checkAndToggle();

            $('input[name="is_check_inspection"], input[name="is_check_lpg_ngv"], input[name="is_check_blue_sign"], input[name="is_check_yellow_sign"], input[name="is_check_green_sign"]')
                .on("change", function() {
                    checkAndToggle();
                });
        });
