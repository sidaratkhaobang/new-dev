...
@include('admin.components.form-save', [
    'store_uri' => route('admin.tax-renewals.store-taxing'),
])
...
@push('scripts')
    <script>
        ...
        $(".btn-save-form-tax-renewal").on("click", function() {
            let storeUri = "{{ route('admin.tax-renewals.store-taxing') }}";
        ...
        jQuery(function() {
            var tax_forwarding_date = '{{ $d->tax_forwarding_date }}';
            flatpickr("#receive_tax_label_date", {
                minDate: tax_forwarding_date,
            });
            flatpickr("#car_tax_exp_date", {
                minDate: tax_forwarding_date,
            });
