...
{{--        @include('admin.components.creator')--}}
        ...
        @include('admin.insurance-deducts.sections.form-deduct')
        <div class="block {{ __('block.styles') }}">
            <div class="block-content">
                <div class="justify-content-between mb-4">
                    <x-forms.submit-group
                        :optionals="['url' => 'admin.insurance-deducts.index', 'view' => empty($view) ? null : $view,'manage_permission' => Actions::Manage . '_' . Resources::InsuranceDeduct]"/>
                </div>
            </div>
        </div>
    </form>
