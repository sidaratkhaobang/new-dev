        ...
        <tbody>
            @foreach ($lt_rental_lines as $car_index => $car_item)
                <tr>
                    ...
                    @endif
                    @endif
                    <td style="text-align: left; vertical-align: top; color: #E04F1A;"><input type="text" class="form-control" value="{{$car_item->remark_quotation}}" name="remark_quotation[{{$car_item->id}}]"></td>
                    {{-- @if($loop->first)
