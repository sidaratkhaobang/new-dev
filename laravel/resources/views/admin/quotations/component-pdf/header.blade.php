<header>
    ...
    <div class="header-text-r">
        ...
        <div class="display-left">
            <p class="ml-50">เลขที่ <span class="ml-50">{{ $qt_no }}@if (isset($d->edit_count))
            ...
            <p class="ml-50">จาก <span class="ml-50">
                    {{ $d->user_name }}</span></p>
            <p class="ml-50">เบอร์โทรศัพท์ <span style="margin-left: 10px;">
                    {{ $d->user_tel }}</span></p>
            <p class="ml-50">อีเมล <span class="ml-50">
                    {{ $d->user_email }}</span></p>
            <p class="ml-50">วันที่สร้าง <span style="margin-left: 30px;">
                    {{ $d->create_date }}</span></p>
            <p class="ml-50">มีผลถึงวันที่ <span style="margin-left: 20px;">
                    {{ $d->end_date }}</span></p>
        </div>
        <hr>
    </div>
