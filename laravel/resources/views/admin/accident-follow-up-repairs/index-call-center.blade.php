...
@section('page_title', __('accident_follow_up_repairs.page_title_call_center'))
                                    ...
                                    <td class="sticky-col text-center">
                                        {{-- @if (strcmp($d->status, AccidentRepairStatusEnum::SUCCESS_REPAIR) !== 0) --}}
                                            @include('admin.components.dropdown-action', [
                                                ...
                                                // ]),
                                                'view_route' => route('admin.call-center-follow-up-repairs.show', [
                                                    'call_center_follow_up_repair' => $d,
                                                ]),
                                                'view_permission' =>
                                                    Actions::View . '_' . Resources::CallCenterFollowUpRepair,
                                                'manage_permission' =>
                                                    Actions::Manage . '_' . Resources::CallCenterFollowUpRepair,
                                            ])
                                    </td>
                                </tr>
                            @endforeach
