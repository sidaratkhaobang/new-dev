...
@section('page_title', __('long_term_rentals.quotation'))
            ...
            <div class="justify-content-between">
                <form action="" method="GET" id="form-search">
                    ...
                    <div class="form-group row push mb-4">
                        ...
                        <div class="col-sm-3">
                            <x-forms.select-option id="status" :value="$status" :list="$rental_price_status_list"
                        ...
                        @foreach ($list as $index => $d)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    {!! badge_render(
                                        __('long_term_rentals.quotation_class_' . $d->rental_price_status),
                                        __('long_term_rentals.quotation_status_' . $d->rental_price_status),
                                    ) !!}

                                </td>
                                <td class="sticky-col text-center">
                                    @include('admin.components.dropdown-action', [
                                        'view_route' => route('admin.long-term-rental.quotations.show', [
                                            'rental' => $d,
                                        ]),
                                        'other_route' => route('admin.long-term-rental.quotations.edit', [
                                            'rental' => $d,
                                        ]),
                                        'other_text' => 'ตั้งราคาเช่า',
                                        'view_permission' => Actions::View . '_' . Resources::LongTermRentalQuotation,
                                        'manage_permission' => Actions::Manage . '_' . Resources::LongTermRentalQuotation,
                                    ])
                                </td>
                            </tr>
                        @endforeach
