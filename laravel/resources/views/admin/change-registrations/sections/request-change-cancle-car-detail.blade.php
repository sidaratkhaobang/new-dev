        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-3">
                <x-forms.label id="lot_name"
                               ...
                               :label="__('change_registrations.detail')"/>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.view-image :id="'optional_file'" :label="__('change_registrations.optional_file')"
                                    :list="$media['optional_cancel_use_car_files'] ?? []"/>
            </div>
        </div>
    </div>
</div>
