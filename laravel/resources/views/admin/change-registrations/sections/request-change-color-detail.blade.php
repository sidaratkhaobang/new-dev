        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-3">
                <x-forms.label id="lot_name"
                               ...
                               :label="__('change_registrations.change_color_request')"/>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <x-forms.view-image :id="'receipt_file'" :label="__('change_registrations.car_change_color_slip')"
                                    :list="$media['receipt_file'] ?? []"/>
                {{--                <x-forms.label id="lot_name"--}}
                {{--                               :value="null"--}}
                {{--                               :label="__('change_registrations.car_change_color_slip')"/>--}}
            </div>
        </div>
    </div>
</div>
