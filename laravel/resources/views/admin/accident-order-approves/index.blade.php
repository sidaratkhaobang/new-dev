...
@section('page_title', __('accident_orders.accident_order_approve'))
                        ...
                        @if (!$list->isEmpty())
                            @foreach ($list as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->scheduled_completion_date }}</td>
                                    ...
                                    <td class="sticky-col text-center">
                                        @include('admin.components.dropdown-action', [
                                            'view_route' => route('admin.accident-order-approves.show', [
                                                'accident_order_approve' => $d,
                                            ]),
