<div class="content">
    ...
    @if (in_array(Route::currentRouteName(), [
        "admin.vmi-cars.edit", 
        "admin.vmi-cars.show",
        "admin.insurance-vmi-renew.edit",
        "admin.insurance-vmi-renew.show",
        "admin.cancel-vmi-cars.edit",
        "admin.cancel-vmi-cars.show",
        ]))
    <hr>
        <div class="row my-4">
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                :optionals="['input_class' => 'number-format', 'required' => true, 'placeholder' => $d->sum_insured_car ?? 0.00]" />
            </div>
            <div class="col-sm-4">
                <x-forms.input-new-line id="sum_insured_accessory" :value="$d->sum_insured_accessory" :label="__('cmi_cars.sum_insured_accessory')" 
                :optionals="['input_class' => 'number-format', 'required' => true, 'placeholder' => $d->sum_insured_accessory ?? 0.00]" />
            </div>
            <div class="col-sm-4">
