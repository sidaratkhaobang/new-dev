    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                ...
                <li class="nav-item">
                    <button class="nav-link" id="btabs-alt-static-form-tab" data-bs-toggle="tab"
                        data-bs-target="#btabs-alt-static-form" role="tab"
                        aria-controls="btabs-alt-static-form"
            ...
            <form id="save-form">
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="btabs-alt-static-info" role="tabpanel"
                        ...
                        @include('admin.short-term-rentals.sections.view')
                    </div>
                    <div class="tab-pane" id="btabs-alt-static-form" role="tabpanel"
