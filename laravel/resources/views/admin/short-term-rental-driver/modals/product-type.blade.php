    ...
    <template v-if="selected_type === 'car'">
        <div class="table-wrap">
            <table class="table table-striped">
                ...
                <thead v-if="product_transport_modal_list.length > 0">
                    <tr v-for="(value,index) in product_transport_modal_list">
                        ...
                        <td class="align-middle">
                            <drop-zone-vue :id="'product-img-'+index" :file="value.product_files">
                            </drop-zone-vue>
                        </td>
                        <td class="align-middle">
