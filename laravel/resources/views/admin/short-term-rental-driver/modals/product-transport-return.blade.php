<x-modal :id="'product-transport-return'" :title="'เพิ่มสินค้านำกลับ'">
    <div class="row push ">
        <div class="col-lg-12 col-sm-12">
            <p>รถที่เลือก</p>
            <template v-if="car_data.length > 0">
                <div class="row push mb-4 border-car-modal-send " v-for="(value,key) in car_data">
        ...
        <div class="col-sm-12 col-lg-12">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex flex-row mb-3" style="cursor: pointer;">
                    <div id="to_left" class="svg-container" data-interval="false" data-bs-target="#carousel_return"
                         data-bs-slide="prev">
                        <img src="{{ asset('images/btn_arrow_left.png') }}">
                    </div>
                    <div id="to_right" class="svg-container ms-3" data-interval="false"
                         data-bs-target="#carousel_return" data-bs-slide="next">
                        <img src="{{ asset('images/btn_arrow_right.png') }}">
                    </div>
                </div>
            </div>
            <div id="carousel_return" class="carousel carousel-dark slide" data-bs-touch="false"
                 data-bs-interval="false">
                <div class="carousel-inner">
                    @include('admin.short-term-rental-driver.components.product-transports-return-carousel-item')
                </div>
            </div>
    ...
    <div class="-row push ">
        ...
        <div class="col-sm-12 col-lg-12">
            @include('admin.short-term-rental-driver.modals.product-type-return')
        </div>
    </div>
    <x-slot name="footer">
        ...
        <button type="button" class="btn btn-primary" onclick="saveProductReturn()">{{ __('lang.save') }}</button>
    </x-slot>
</x-modal>
