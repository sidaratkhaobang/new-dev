    ...
    <div class="col-sm-6 col-lg-4 border-product ms-2 me-2 mt-2 mb-2" style="padding: 24px;">
        <div class="d-flex">
            <div class="me-2 d-flex justify-content-center align-items-center">
                <template v-if="item.product_files.length > 0">
                    <img class="img-block   img-car-send" :src="item.product_files[0].url" alt="">
                </template>
                <template v-else>
        ...
        <div class="row push mb-4">
            ...
            <div class="col-sm-12 col-lg-4">
                ...
                <b style="font-weight: bold;" class="text_class d-block">@{{
                    Number(item.weight_m.replace(/,/g, '')).toLocaleString('en-US') }}</b>
            </div>
            <div class="col-sm-12 col-lg-4">
    ...
    <div class="col-sm-6 col-lg-4 border-product ms-2 me-2 mt-2 mb-2" style="padding: 24px;">
        ...
        <div class="row push mb-4">
            ...
            <div class="col-sm-12 col-lg-4">
                <label for="" class="">น้ำหนัก (กิโลกรัม)</label>
                <b style="font-weight: bold;" class="text_class d-block">@{{
                    Number(item.weight_m.replace(/,/g, '')).toLocaleString('en-US')
                    }}</b>
            </div>
        </div>
    </div>
