...
@endsection --}}
    ...
    <div class="block-content">
        ...
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.select-option id="car_characteristic" :value="$d->car->carCharacteristic->id ?? null" :list="$car_characteristic_list" :label="__('registers.car_characteristic')"
                    :optionals="['required' => true]" />
            </div>
            <div class="col-sm-3">
                <x-forms.select-option id="car_category" :value="$d->car->carCategory->id ?? null" :list="$car_category_list" :label="__('registers.car_category')"
                    :optionals="['required' => true]" />
            </div>
            <div class="col-sm-3">
                <x-forms.select-option id="register_sign" :value="$d->registered_sign" :list="$register_sign_list" :label="__('registers.license_plate_registered')"
                    :optionals="['required' => true]" />
            </div>
        </div>
        <div class="row mb-4">
        ...
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.select-option id="color_registered" :value="$d->color_registered ?? null" :list="$color_registered_list" :label="__('registers.color_registered')"
                    :optionals="['required' => true]" />
            </div>
            <div class="col-sm-3">
                <x-forms.select-option id="car_characteristic_transport_id" :value="$d->car_characteristic_transport_id ?? null" :list="$car_characteristic_transport_list" :label="__('registers.car_characteristic_transport')"
                    :optionals="['required' => true]" />
            </div>
        </div>
    </div>
