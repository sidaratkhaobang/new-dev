<x-blocks.block-search>
    <form action="" method="GET" id="form-search">
        <div class="row mb-4">
            ...
            <div class="col-sm-3">
                <x-forms.select-option id="lot_no" :value="null" :list="[]" :optionals="[
                            'select_class' => 'js-select2-custom',
                            'ajax' => true,
                            'default_option_label' => null,
        ...
        <div class="row mt-4">
            <div class="col-sm-12 text-end">
                <button type="button" onclick="clearSelectCar()" class="btn btn-outline-secondary btn-custom-size me-1"><i class="fa fa-rotate-left"></i>
