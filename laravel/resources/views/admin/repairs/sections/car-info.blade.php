<div class="block {{ __('block.styles') }}">
    <div class="block-content">
        <div class="d-md-flex justify-content-md-between align-items-md-center">
            ...
            <div id="car-btn-modal" @if ($car_data->id) style="display: block;" @else  style="display: none;" @endif>
                <a class="btn btn-sm btn-primary px-3 me-1 my-1" onclick="openModalAccident()"
