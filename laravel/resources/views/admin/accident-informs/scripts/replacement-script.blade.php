        ...
        let addAccidentReplacementVue = new Vue({
            ...
            methods: {
                ...
                loadModalData: function(index) {
                    ...
                    if (replacement_files.length > 0) {
                        replacement_files.forEach(item => {
                            ...
                            var preview_link = $(
                                '.dz-replacment_file-preview-content > .dz-content > [data-dz-name]'
                            ).eq(index);
                ...
                validateDataObject: function(slide) {
                    // .log(slide);
                    if (slide.replacement_type && slide.replacement_pickup_date && slide.customer_receive &&
                        slide.slide_worksheet && slide
                        .place) {
                        return true;
                    } else {
                        return false;
                ...
                saveAdd: function() {
                    ...
                    if (this.validateDataObject(replacement_sheet)) {
                        ...
                        if (this.btn_group_sheet == true) {
                            var storeUri =
                                "{{ route('admin.accident-inform-sheets.save-replacment-accident') }}";
                        } else {
                            var storeUri = "{{ route('admin.accident-informs.save-replacment-accident') }}";
                        }
