...
@section('page_title', __('accident_informs.page_title_sheet'))
        ...
        <div class="block-options-item">
            @can(Actions::Manage . '_' . Resources::AccidentInformSheet)
                <x-btns.add-new btn-text="{{ __('garages.add_new') }}"
                    route-create="{{ route('admin.accident-inform-sheets.create') }}" />
            @endcan
        </div>
    </div>
@endsection
                ...
                <form action="" method="GET" id="form-search">
                    <div class="form-group row push mb-4">
                        <div class="col-sm-3">
                            ...
                            <x-forms.select-option :value="$worksheet" id="worksheet" :list="null" :label="__('accident_informs.worksheet_no')"
                                :optionals="[
                        ...
                        <div class="col-sm-3">
                            <x-forms.select-option id="status" :value="$status" :list="$status_list"
                                :label="__('accident_informs.status')" />
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="sticky-col text-center">
                                        @include('admin.components.dropdown-action', [
                                            'edit_route' => route('admin.accident-inform-sheets.edit', [
                                                'accident_inform_sheet' => $d,
                                            ]),
                                            'view_route' => route('admin.accident-inform-sheets.show', [
                                                'accident_inform_sheet' => $d,
                                            ]),
                                            'view_permission' =>
                                                Actions::View . '_' . Resources::AccidentInformSheet,
                                            'manage_permission' =>
                                                Actions::Manage . '_' . Resources::AccidentInformSheet,
                                        ])
                                    </td>
                                </tr>
                            @endforeach
