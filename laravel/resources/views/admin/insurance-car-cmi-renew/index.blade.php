...
@section('page_title', 'ต่ออายุ พรบ.')
@push('styles')
    <style>
        .seperator {
            font-size: xx-large;
...
@section('content')
    <div class="block {{ __('block.styles') }}">
        ...
        @include('admin.insurance-car-cmi-renew.modals.start-cmi')
    </div>
                            ...
                            @foreach ($list as $d)
                                <tr>
                                    ...
                                    <td class="sticky-col text-center">
                                        @include('admin.insurance-car-cmi-renew.sections.dropdown-actions')
                                    </td>
                                </tr>
                            @endforeach
                        @else
...
@include('admin.insurance-car-cmi-renew.scripts.start-cmi-script')
@include('admin.insurance-car-cmi-renew.scripts.export-cmi-script')
@include('admin.insurance-car-cmi-renew.scripts.import-cmi-script')
