<div class="row mb-4">
    <div class="col-sm-3">
        <x-forms.select-option id="car_id" :list="[]" :value="$d->car_id" :label="__('cars.license_plate')" :optionals="['required' => true, 'ajax' => true, 'default_option_label' => $car_name]" />
...
<div class="row mb-4">
    ...
    <div class="col-sm-3">
        <x-forms.input-new-line id="cc" :value="$d->cc" :label="__('car_classes.engine_size')" />
    </div>
    <div class="col-sm-3">
...
<div class="row mb-4">
    <div class="col-sm-3">
        <x-forms.input-new-line id="color_registered" :value="$d->color_registered" :label="__('registers.color_registered')" />
    </div>
    <div class="col-sm-3">
        <x-forms.input-new-line id="registered_sign" :value="$d->registered_sign" :label="__('registers.license_plate_registered')" />
    </div>
    <div class="col-sm-3">
        <x-forms.input-new-line id="car_characteristic_transport" :value="null" :label="__('registers.car_characteristic_transport')" />
    </div>
    <div class="col-sm-3">
...
<div class="row mb-4">
    ...
    <div class="col-sm-3">
        <x-forms.input-new-line id="copy_pattern" :value="$d->registered_sign" :label="__('change_registrations.copy_pattern')" />
    </div>
</div>
