                    ...
                    <tbody v-if="repair_list.length > 0">
                        <tr v-for="(item, index) in repair_list">
                            ...
                            <td class="align-middle">
                                <select-2-wound :id="'wound_characteristics_id' + index" class="form-control list_in"
                                    style="width: 100%;" v-model="repair_list[index].wound_characteristics_id">
                                </select-2-wound>
                                <input type="hidden"
                                    v-bind:name="'repair_list['+ index + '][wound_characteristics_id]'"
                                    id="wound_characteristics_id" v-model="repair_list[index].wound_characteristics_id">
                            </td>
