...
@section('page_title', __('accident_orders.page_title'))
                ...
                <table class="table table-striped table-vcenter">
                    <thead class="bg-body-dark">
                        <tr>
                            ...
                            <th style="width: 25%;">@sortablelink('cradle_name', __('accident_informs.garage'))</th>
                            ...
                            <th style="width: 25%;">@sortablelink('actual_repair_date', __('accident_orders.actual_repair_date'))</th>
                                    ...
                                    <td class="sticky-col text-center">
                                        @if (strcmp($d->status, AccidentRepairStatusEnum::SUCCESS_REPAIR) !== 0)
                                            @include('admin.components.dropdown-action', [
                                                'edit_route' => route('admin.accident-orders.edit', [
                                                    'accident_order' => $d,
                                                ]),
                                                'view_route' => route('admin.accident-orders.show', [
                                                    'accident_order' => $d,
                                                ]),
                                                'view_permission' =>
                                                    Actions::View . '_' . Resources::AccidentOrder,
                                                'manage_permission' =>
                                                    Actions::Manage . '_' . Resources::AccidentOrder,
                                            ])
                                        @else
                                            @include('admin.components.dropdown-action', [
                                                'view_route' => route('admin.accident-orders.show', [
