<div class="modal fade" id="modal-start-vmi" aria-labelledby="modal-start-vmi" aria-hidden="false">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-popout">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="icon-document me-2"></i> {{ __('vmi_cars.make_vmi') }}</h5>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody v-if="selected_list.length > 0">
                                <tr v-for="(item, index) in selected_list">
                                    ...
                                    <td>@{{ item.year }}</td>
                                    <td>@{{ (item.car && item.car.license_plate) ? item.car.license_plate : '-' }}</td>
