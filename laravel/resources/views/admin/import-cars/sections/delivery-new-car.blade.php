<div class="row push mb-4">
    <div class="col-sm-4">
        ...
        <div class="input-group">
            <input class="form-control delivery_date_modal js-flatpickr form-control flatpickr-input" id="delivery_date"
    ...
    <div class="col-sm-8 ">
        ...
        <div class="input-group">
            <input class="form-control delivery_place_modal js-flatpickr form-control flatpickr-input"
                id="delivery_place" name="delivery_place" placeholder="">
        </div>
    </div>
</div>
<div class="row push mb-4">
