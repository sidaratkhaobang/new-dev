<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $d->term_start_date ? get_date_time_by_format($d->term_start_date, 'd/m/Y H:i:s') : null  }}</td>
            <td>{{ $d->term_end_date ? get_date_time_by_format($d->term_end_date, 'd/m/Y H:i:s') : null }}</td>
            ...
            <td>{{ $d->tax_invoice_no }}</td>
            <td>{{ $d->statement_date ? get_date_time_by_format($d->statement_date, 'd/m/Y H:i:s') : null }}</td>
            <td>{{ $d->account_submission_date ? get_date_time_by_format($d->account_submission_date, 'd/m/Y H:i:s') : null }}</td>
            <td>{{ $d->operated_date ? get_date_time_by_format($d->operated_date, 'd/m/Y H:i:s') : null }}</td>
        </tr>
        @endforeach
    </tbody>
</table>