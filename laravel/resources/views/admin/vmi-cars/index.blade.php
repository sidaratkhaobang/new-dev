...
@section('page_title', __('vmi_cars.page_title'))
...
@section('content')
    <div class="block {{ __('block.styles') }}">
        ...
        @include('admin.vmi-cars.modals.start-vmi')
    </div>
                        ...
                        @if (sizeof($list) > 0)
                            ...
                            <tr>
                                ...
                                <td class="sticky-col text-center">
                                    @include('admin.vmi-cars.sections.dropdown-actions')
                                </td>
                            </tr>
                            @endforeach
                        @else 
...
@include('admin.vmi-cars.scripts.start-vmi-script')
@include('admin.vmi-cars.scripts.export-vmi-script')
@include('admin.vmi-cars.scripts.import-vmi-script')
