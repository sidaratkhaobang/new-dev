...
@section('page_title', __('gps.job') . __('gps.page_title_data'))
                                    ...
                                    <td class="sticky-col text-center">
                                        @if (strcmp($d->status, GPSHistoricalDataStatusEnum::REQUEST) == 0)
                                            @include('admin.components.dropdown-action', [
                                                'view_route' => route('admin.gps-historical-data-jobs.show', [
                                                    'gps_historical_data_job' => $d,
                                                ]),
                                                'edit_route' => route('admin.gps-historical-data-jobs.edit', [
                                                    'gps_historical_data_job' => $d,
                                                ]),
                                                'view_permission' =>
                                                    Actions::View . '_' . Resources::GPSHistoricalDataJob,
                                                'manage_permission' =>
                                                    Actions::Manage . '_' . Resources::GPSHistoricalDataJob,
                                            ])
                                        @else
                                            @include('admin.components.dropdown-action', [
                                                'view_route' => route('admin.gps-historical-data-jobs.show', [
