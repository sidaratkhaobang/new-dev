...
@section('page_title', __('record_petty_cashes.page_title_check'))
            ...
            <div class="justify-content-between">
                <form action="" method="GET" id="form-search">
                    <div class="form-group row push mb-4">
                        <div class="col-sm-3">
                            <x-forms.select-option id="record_no" :value="null" :list="null" :label="__('record_petty_cashes.record_no')" />
                        </div>
                        <div class="col-sm-3">
                            <x-forms.select-option id="branch" :value="null" :list="null" :label="__('record_petty_cashes.branch')" />
                        </div>
                        <div class="col-sm-3">
