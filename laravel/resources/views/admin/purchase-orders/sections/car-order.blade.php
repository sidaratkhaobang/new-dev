    ...
    <div class="table-wrap">
        <table class="table table-vcenter table-hover">
            <thead class="bg-body-dark">
                ...
                <th style="width: 100px;" class="text-end">{{ __('purchase_orders.discount') }}</th>
            ...
            <tbody>
                ...
                @if (sizeof($purchase_requisition_car_list) > 0)
                    ...
                    <tr id="tr_{{ $purchase_requisition_car->id }}" >
                        ...
                        <td style="width: 30%;">
                            <div class="row hstack">
                                <div class="col-sm-6">
                                    ...
                                    data-car-class-id="{{ $purchase_requisition_car->car_id }}"
                        ...
                        <td style="width: 100px;" class="discount-total text-end" id="discount_total_{{ $purchase_requisition_car->id }}">-</td>
                        <input type="hidden" value="" id="selected_cars[{{ $purchase_requisition_car->id }}][discount]" 
                            name="selected_cars[{{ $purchase_requisition_car->id }}][discount]">
                    ...
                    <tr>
                        ...
                        <th class="summary-discount-total text-end">-</th>
                        ...
                        <input type="hidden" value="" id="summary_discount_total" name="summary_discount_total" >
