    ...
    <div class="table-wrap">
        <table class="table table-vcenter table-hover">
            <thead class="bg-body-dark">
                ...
                <th class="text-end">{{ __('purchase_orders.discount') }}</th>
            ...
            <tbody>
                ...
                @if (sizeof($purchase_order_lines) > 0)
                    ...
                    <tr id="tr_{{ $purchase_order_line->id }}" >
                        ...
                        <td class="discount-total text-end" id="discount_total_{{ $purchase_order_line->id }}">{{ number_format($purchase_order_line->discount, 2) }}</td>
                    ...
                    <tr>
                        ...
                        <th class="summary-discount-total text-end">{{ number_format($d->discount, 2) }}</th>
