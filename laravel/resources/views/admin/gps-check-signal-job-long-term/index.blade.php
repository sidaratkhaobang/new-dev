...
@section('block_options_list')
    <div class="block-options-item">
        @can(Actions::Manage . '_' . Resources::GPSCheckSignalLongTerm)
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdown-dropleft-dark">
                                                @can(Actions::View . '_' . Resources::GPSCheckSignalLongTerm)
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.gps-check-signal-job-long-term.show', ['gps_check_signal_job_long_term' => $d]) }}"><i
                                                ...
                                                @can(Actions::Manage . '_' . Resources::GPSCheckSignalLongTerm)
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.gps-check-signal-job-long-term.edit', ['gps_check_signal_job_long_term' => $d]) }}"><i
