<div class="modal fade" id="modal-purchase-order-dealer" aria-labelledby="modal-purchase-order-dealer" aria-hidden="false">
                ...
                <div class="table-wrap mb-5">
                    <table class="table table-striped">
                        <thead class="bg-body-dark">
                            ...
                            <th>{{ __('long_term_rentals.discount') }}</th>
                            ...
                            @if (sizeof($purchase_requisition_car_list) > 0)
                                @foreach ($purchase_requisition_car_list as $index => $purchase_requisition_car)
                                    <tr id="{{$purchase_requisition_car->id}}">
                                        ...
                                        <td style="width: 20%;white-space: normal;">
                                            <input type="text" class="form-control number-format"
                                                id="{{ $purchase_requisition_car->id }}_discount_field"
                                                name="{{ $purchase_requisition_car->id }}_discount_field" placeholder=""
                                                maxlength="10" required min="0">
                                        </td>
                                        <td class="text-end">
