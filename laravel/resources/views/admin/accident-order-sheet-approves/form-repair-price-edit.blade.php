...
@section('content')
    ...
    @endif --}}
    <x-approve.step-approve :configenum="ConfigApproveTypeEnum::ACCIDENT_REPAIR_ORDER_SHEET" :id="$d->id" :model="get_class($d)" />
    ...
    <form id="save-form">
        ...
        @include('admin.accident-order-sheet-approves.sections.repair-detail-edit')
        ...
        @include('admin.accident-order-sheet-approves.sections.remark')
        ...
        @include('admin.accident-order-sheet-approves.submit')
...
@include('admin.accident-order-sheet-approves.scripts.update-status')
...
@push('scripts')
    <script>
        ...
        //     let storeUri = null;
        //         storeUri = "{{ route('admin.accident-orders.store-edit-repair-price') }}";
        ...
        $('input[name="is_appointment[]"]').on("click", function() {
            ...
            // console.log(isChecked , {{ STATUS_ACTIVE }})
