...
@section('page_title', __('accident_orders.accident_order_sheet_approve'))
                        ...
                        @if (!$list->isEmpty())
                            @foreach ($list as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->scheduled_completion_date ? get_date_time_by_format($d->scheduled_completion_date, 'd/m/Y') : '' }}
                                    </td>
                                    ...
                                    <td class="sticky-col text-center">
                                        @include('admin.components.dropdown-action', [
                                            'view_route' => route('admin.accident-order-sheet-approves.show', [
                                                'accident_order_sheet_approve' => $d,
                                            ]),
