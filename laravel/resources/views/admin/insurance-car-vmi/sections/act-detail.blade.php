<div class="block {{ __('block.styles') }}">
    ...
    @section('block_options_renew')
        <div class="block-options">
            <div class="block-options-item">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-cmi-renew">
    ...
    <div class="block-content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-6">
                <x-forms.select-option :value="$d->insurance_package_id" id="insurance_package_id" :list="null"
                                       :label="__('vmi_cars.condition')"
        ...
        <div class="row  mb-4">
            ...
            <div class="col-sm-3">
                <x-forms.date-input id="receive_date" :value="$d->receive_date"
                                    :label="__('cmi_cars.receive_doc_date')"/>
            </div>
            <div class="col-sm-3">
        ...
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.input-new-line id="policy_reference_vmi" :value="$d->policy_reference_vmi"
                                        :label="__('vmi_cars.policy_reference_vmi')"/>
            </div>
            <div class="col-sm-3">
                <x-forms.input-new-line id="endorse_vmi" :value="$d->endorse_vmi" :label="__('vmi_cars.endorse_vmi')"/>
            </div>
            <div class="col-sm-3">
                <x-forms.input-new-line id="policy_reference_child_vmi" :value="$d->policy_reference_child_vmi"
                                        :label="__('vmi_cars.policy_reference_child_vmi')"/>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-sm-3">
                <x-forms.date-input id="term_start_date" :value="$d->term_start_date"
                                    :label="__('cmi_cars.policy_start_date')"/>
            </div>
            <div class="col-sm-3">
                <x-forms.date-input id="term_end_date" :value="$d->term_end_date"
                                    :label="__('cmi_cars.policy_end_date')"/>
            </div>
        </div>
    </div>
</div>
