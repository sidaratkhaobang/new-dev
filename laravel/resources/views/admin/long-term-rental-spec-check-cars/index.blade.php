...
@section('page_title', __('long_term_rentals.check_car'))
@push('custom_styles')
    <style>
        .input-group-text {
                                ...
                                <td class="sticky-col text-center" style="width: 100px;">
                                    @if (in_array($d->spec_status, [SpecStatusEnum::PENDING_REVIEW, SpecStatusEnum::CONFIRM, SpecStatusEnum::NO_DELIVERY]))
                                        @include('admin.components.dropdown-action', [
                                            'view_route' => route('admin.long-term-rental.spec-check-cars.show', [
                                                'rental' => $d,
                                            ]),
                                            'view_permission' =>
                                    ...
                                    @else
                                        @include('admin.components.dropdown-action', [
                                            ...
                                            'edit_route' => route('admin.long-term-rental.spec-check-cars.edit', [
                                                'rental' => $d,
                                            ]),
                                            'view_permission' =>
                                                Actions::View . '_' . Resources::LongTermRentalSpecCheckCar,
                                            'manage_permission' =>
                                                Actions::Manage . '_' . Resources::LongTermRentalSpecCheckCar,
                                        ])
                                    @endif
                                </td>
                            </tr>
