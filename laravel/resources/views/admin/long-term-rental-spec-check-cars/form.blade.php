...
@section('content')
    ...
    <div class="block {{ __('block.styles') }}">
        ...
        <div class="block-content">
            <form id="save-form">
                @include('admin.long-term-rental-spec-check-cars.sections.rental-detail')
                @include('admin.long-term-rental-spec-check-cars.sections.upload')
                @include('admin.long-term-rental-spec-check-cars.sections.car-accessory')
                        ...
                        <div class="col-md-12 text-end">
                            @if (!isset($accessory_controller))
                                @if (strcmp($d->spec_status, SpecStatusEnum::PENDING_CHECK) !== 0)
                                    @can(Actions::Manage . '_' . Resources::LongTermRentalSpecCheckCar)
                ...
                @endif
                @if (strcmp($d->spec_status, SpecStatusEnum::PENDING_CHECK) === 0)
                    @include('admin.long-term-rental-spec-check-cars.sections.car-check')
...
@include('admin.components.form-save', [
    'store_uri' => route('admin.long-term-rental.spec-check-cars.store'),
])
...
@if (strcmp($d->spec_status, SpecStatusEnum::PENDING_CHECK) === 0)
    @include('admin.long-term-rental-spec-check-cars.scripts.input-tag')
@endif
...
@push('scripts')
    <script>
        ...
        $('#remark_detail').prop('disabled', true);
        ...
        $('#car_remark_field').prop('disabled', true);
        $("input[name=have_accessory_field]").attr('disabled', true);
        ...
        $(".btn-save-review").on("click", function() {
            let storeUri = "{{ route('admin.long-term-rental.spec-check-cars.store') }}";
