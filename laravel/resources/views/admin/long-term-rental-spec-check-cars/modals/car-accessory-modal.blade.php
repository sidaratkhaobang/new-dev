    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-popout" style="width:1250px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row push mb-3">
                    <div class="col-sm-12">
                        <x-forms.text-area-new-line id="car_remark_field" :value="null" :label="__('long_term_rentals.remark')" />
                    </div>
                </div>
                <div class="row push mb-3">
                    <div class="col-sm-12">
            ...
            <div class="modal-body">
                ...
                <div class="row push mb-3">
                    <div class="col-sm-12">
                        <x-forms.text-area-new-line id="remark" :value="null" :label="__('long_term_rentals.remark')" />
                    </div>
                </div>
                <div class="row mb-4">
