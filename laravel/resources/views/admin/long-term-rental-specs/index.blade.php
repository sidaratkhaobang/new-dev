...
@section('page_title', __('long_term_rentals.specs_and_equipment'))
@push('custom_styles')
    <style>
        .input-group-text {
            ...
            <div class="justify-content-between">
                <form action="" method="GET" id="form-search">
                    <div class="form-group row push mb-4">
                        ...
                        <div class="col-sm-3">
                            <x-forms.select-option id="lt_rental_type" :value="$lt_rental_type" :list="$lt_rental_type_list"
                    ...
                    <div class="form-group row push mb-4">
                        ...
                        <div class="col-sm-3">
                            <x-forms.select-option id="status" :value="$status" :list="$status_lists" :label="__('lang.status')" />
                        </div>
                    </div>
                            ...
                            @foreach ($lists as $index => $d)
                                <tr>
                                    ...
                                    <td class="sticky-col text-center">
                                        @if (in_array($d->spec_status, [SpecStatusEnum::PENDING_REVIEW, SpecStatusEnum::CONFIRM, SpecStatusEnum::NO_DELIVERY]))
                                        ...
                                        @else
                                            @include('admin.components.dropdown-action', [
                                                ...
                                                'edit_route' => route('admin.long-term-rental.specs.edit', [
                                                    'rental' => $d,
                                                ]),
                                                'view_permission' =>
                                                    Actions::View . '_' . Resources::LongTermRentalSpec,
                                                'manage_permission' =>
                                                    Actions::Manage . '_' . Resources::LongTermRentalSpec,
                                            ])
                                        @endif
                                    </td>
                                </tr>
