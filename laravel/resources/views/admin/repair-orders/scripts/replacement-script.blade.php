        ...
        let addReplacementVue = new Vue({
            ...
            methods: {
                ...
                getDataFromModal: function() {
                    var main_car_id = document.getElementById("main_car_id").value;
                    var main_license_plate  = document.getElementById('car_license').value;
                ...
                callFormSave: async function(replacement_car) {
                    ...
                    var job_id = document.getElementById("repair_no").value;
                    var main_car_id = document.getElementById("main_car_id").value;
